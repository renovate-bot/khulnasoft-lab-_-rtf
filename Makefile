...
CMD_PKG=github.com/khulnasoft-lab/rtf/cmd
...
# Build with docker
GO_COMPILE=khulnasoft/go-compile:7cac05c5588b3dd6a7f7bdb34fc1da90257394c7
...
tmp_rtf_bin.tar: $(DEPS)
	tar cf - . | docker run --rm --net=none --log-driver=none -i $(CROSS) $(GO_COMPILE) --package github.com/khulnasoft-lab/rtf --ldflags "-X main.GitCommit=$(GIT_COMMIT) -X main.Version=$(VERSION)" -o rtf > $@
